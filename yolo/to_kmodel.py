...
def main():
    ...
    parser.add_argument("--model", default=r"C:\Users\30324\Desktop\yolo\best.onnx",type=str, help='model file')
    parser.add_argument("--dataset", default=r"C:\Users\30324\Desktop\yolo\yolo_dataset\images\train", type=str, help='calibration_dataset')
