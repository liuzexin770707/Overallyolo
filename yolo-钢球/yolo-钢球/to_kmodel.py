...
def main():
    ...
    parser.add_argument("--model", default=r".\runs\detect\yolo_runs\train_exp_1-2\weights\best.onnx",type=str, help='model file')
    parser.add_argument("--dataset", default=r".\yolo_dataset\images\train", type=str, help='calibration_dataset')
