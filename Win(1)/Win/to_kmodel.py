...
def main():
    ...
    parser.add_argument("--model", default=r"D:\Name\Code\YOLO\Win\yolo_runs\train_exp_1\weights\best.onnx",type=str, help='model file')
    parser.add_argument("--dataset", default=r"D:\Name\Code\YOLO\Win\yolo_dataset\images\train", type=str, help='calibration_dataset')
    ...
    parser.add_argument("--ptq_option", type=int, default=4, help='ptq_option:0,1,2,3,4')
